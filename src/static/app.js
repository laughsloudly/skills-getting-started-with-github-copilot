document.addEventListener("DOMContentLoaded", () => {
  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    const activity = deleteURIComponent(deleteButton.dataset.activity || "");
    const email = deleteURIComponent(deleteButton.dataset.email || "");
  ...
  function deleteURIComponent(value) {
    try {
